  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      if (constraints.maxWidth > 800) {
          return ListTransactionWeb();
        } else {
          return ListTransactionMobile();
        }
    });
  }
}

class ListTransactionWeb extends StatelessWidget {
              ...
              child: Column(
                children: [
                  Align(
                    ...
                    child: Text('My Transactions', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),)),
                  ListView.builder(
                    shrinkWrap: true,
...
class ListTransactionMobile extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var width = MediaQuery.of(context).size.width;
    var height = MediaQuery.of(context).size.height;
